        ...
        <ul class="inline-flex -space-x-px">
            ...
            <li>
                <span
                    ...
                    @click="globalStore.previousPage()">
                    Previous
                </span>
            </li>
            <li v-for="(n) in numOfPages" :key="n">
                <span
                    ...
                    :class="{ 'text-blue-800 bg-blue-200': page === n }" @click="() => globalStore.handleChangePage(n)">
                    {{ n }}
                </span>
            </li>
            <li>
...
const { numOfPages, page } = storeToRefs(globalStore);
